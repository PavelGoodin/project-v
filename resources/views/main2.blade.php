...
<head>
    ...
    <link href="{{ URL::asset('resources/css/bootstrap.css') }}" rel="stylesheet" type="text/css">
</head>
<body>
    ...
    <div class="thumbnail">
        ...
        <div class="caption">
            ...
            <form action="http://internet-shop.tmweb.ru/basket/add/1" method="POST">
                ...
                <input type="hidden" name="_token" value="xVcW755MjkAUcjUpxWYpPKSvJllvhWbPdaJ8nSie">            </form>
            </p>
        </div>
    </div>
</div>
